...
const LoginPage: React.FC<LoginPageProps> = ({ onBack, onLoginSuccess, onSwitchToRegister }) => {
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12">
                    ...
                    <div className="w-full max-w-[480px] bg-black/30 backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 md:p-12 shadow-2xl">
                        <div className="mb-10 text-center lg:text-left">
                            <h2 className="text-3xl font-medium text-white mb-2">{t('login.form.title')}</h2>
                            <p className="text-gray-300 text-sm font-light">{t('login.form.subtitle')}</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-end">
                                    <a href="#" className="text-[11px] text-gray-400 hover:text-white transition-colors">{t('login.forgot')}</a>
                                </div>
                            </div>
